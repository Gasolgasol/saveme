...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!-- saved from url=(0035)https://demo.templatic.com/answers/ -->
<html lang="en" xmlns="http://www.w3.org/1999/xhtml"><head profile="http://gmpg.org/xfn/11"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>
...
<link rel="pingback" href="https://demo.templatic.com/answers/xmlrpc.php">
	...
	<link rel="stylesheet" href="${contextPath}/resources/css/print.css"  rel="stylesheet" type="text/css">
<link rel="stylesheet" href="${contextPath}/resources/css/menu.css" rel="stylesheet" type="text/css">
...
<link href="${contextPath}/resources/css/1-default.css" rel="stylesheet">
...
<link id="noteanywherecss" media="screen" rel="stylesheet" href="data:text/css,.note-anywhere%20.closebutton%7Bbackground-image%3A%20url%28chrome-extension%3A//bohahkiiknkelflnjjlipnaeapefmjbh/asset/deleteButton.png%29%3B%7D%0A"></head>

<body class="home blog">
		<div id="top_strip">
			<div id="top_strip_in" class="clearfix">
			<div id="topmenu" class="menu"><div id="menu-button">Menu</div><div class="menu-top-nav-container"><ul id="menu-top-nav" class="menu"><li id="menu-item-153" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-153"><a target="_self" href="${contextPath}">HOME</a></li>
    ...
    <c:when test="${pageContext.request.userPrincipal.name != null}">
		...
		<div id="header">
			<div id="header_in" class="clearfix">
									 ...
									 <div class="logo"><a href="${contextPath}"><img src="${contextPath}/resources/images/logo.png" alt="Answers"></a>
					</div>
 ...
 <div class="question_list">
  ...
  <div class="pagination">
	...
	<div class="widget login_widget">
		...
		<div class="widget">			<div class="textwidget"><a href="https://templatic.com/app-themes/answers"><img src="${contextPath}/resources/images/answers-banner-1.jpg"></a></div>
						...
						<div class="user-details">
							<div class="user-pic">
								<a href="https://demo.templatic.com/answers/author/satyajit/">
									<img name="user_photo" class="agent_photo" id="user_photo" src="${contextPath}/resources/images/avatar_post.png" width="64" height="64">								</a>
							</div>
    ...
    <div id="footer">
    	<div id="footer_in">
            ...
            <p> © 2020 Answers  All right reserved.</p>
				 ...
				 <p class="author"> <span class="designby">Appointment WordPress theme </span>  <span class="templatic"> <a href="https://templatic.com/cms-themes/" alt="wordpress themes" title="Wordpress themes"><img src="${contextPath}/resources/images/templatic-wordpress-themes.png" alt="wordpress themes"></a>  </span></p>								
